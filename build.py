...
<article class="lecture" id="pokemon-seminar"><div class="number">↻</div><div><h3>Лекция-семинар: EDA, PCA и t-SNE</h3><p>Повторение на покемонах и рукописных цифрах: распределения, стандартизация, уменьшение размерности. В HTML-презентации пять анимаций PCA: отмечены справа сверху, запуск кнопкой «Анимация» или пробелом.</p><div class="links"><a href="materials/pokemon_lecture_animated.html">Презентация с анимациями · HTML</a><a href="materials/pokemon_lecture.pdf">Слайды · PDF</a><a href="materials/pokemon_student_pack.zip" download>Ноутбук и данные · ZIP</a></div><p>Распакуйте ZIP целиком и откройте ноутбук; инструкция и зависимости внутри. В PDF показаны статичные кадры.</p></div></article>
...
<div class="tablewrap"><table><caption class="skip">Пороги итоговой оценки и формат экзамена</caption><thead><tr><th scope="col">Оценка</th><th scope="col">Сумма баллов</th><th scope="col">Экзамен</th></tr></thead><tbody><tr><th scope="row">3 · Удовлетворительно</th><td>60–74 включительно</td><td>Теоретический</td></tr><tr><th scope="row">4 · Хорошо</th><td>Больше 74 и до 90 включительно</td><td>Теория или итоговый проект</td></tr><tr><th scope="row">5 · Отлично</th><td>Больше 90 и до 100 включительно</td><td>Итоговый проект</td></tr></tbody></table></div><p class="note">Для положительной оценки обе рубежки должны быть закрыты: <strong>минимум 6 из 10 за каждую</strong>.</p>
...
for key in ['organization_url','grades_url','archive_folder_url','updated','bot_url']:
