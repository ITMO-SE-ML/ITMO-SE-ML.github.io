...
bot_link=(f'<a class="button" href="{e(cfg["bot_url"],quote=True)}">Открыть TAIGA в Telegram</a>' if cfg.get('bot_url') else '<p class="note">Ссылка на бота будет добавлена. Ниже — инструкция по регистрации и получению домашнего задания.</p>')
...
<div class="quick"><a href="#homework"><strong>Домашние задания</strong><small>Условия и репозитории</small></a><a href="@@grades_url@@"><strong>Ведомость</strong><small>Журнал проверок ДЗ 2026</small></a><a href="#taiga"><strong>Бот TAIGA</strong><small>Регистрация и получение ДЗ</small></a></div></header>
<section id="materials"><div class="sectionhead"><h2>Лекции и практика</h2><span>Актуальные материалы · 2026/27</span></div>
<div class="lectures">
<article class="lecture"><div class="number">01</div><div><h3>Машинное обучение и анализ данных</h3><p>Задачи ML, этапы работы с данными, признаки, визуализация и базовый EDA.</p><div class="links"><a href="materials/lecture-01.pdf">Слайды · PDF</a><a href="materials/lecture-01-source.zip" download>Исходники · ZIP</a><a href="materials/eda-wine.py" download>Пример EDA · Python</a></div></div></article>
<article class="lecture"><div class="number">02</div><div><h3>EDA и уменьшение размерности</h3><p>Распределения, статистический анализ, стандартизация, проклятие размерности и PCA.</p><div class="links"><a href="materials/lecture-02.pdf">Слайды · PDF</a><a href="materials/lecture-02-source.zip" download>Исходники · ZIP</a></div></div></article>
...
<p class="note">Условия находятся в общих репозиториях. Личный репозиторий для выполнения работы получите через TAIGA: <a href="#taiga">инструкция ниже</a>. Доступность выдачи задания проверяйте в боте.</p></section>
<section id="taiga"><div class="sectionhead"><h2>Как получить домашку</h2><span>TAIGA · Telegram</span></div><div class="botbox"><h3>Зарегистрируйтесь и создайте личный репозиторий</h3>@@bot_link@@
<ol><li>В боте отправьте <code>/start</code> и введите номер ИСУ.</li><li>Проверьте найденные ФИО и группу. Если записи нет в списке, укажите ФИО и выберите группу.</li><li>Введите свой GitHub login <strong>без @ и без ссылки</strong>.</li><li>Откройте <code>/assignments</code>, выберите работу и нажмите «Создать репу».</li><li>Сначала примите приглашение на GitHub, затем откройте созданный репозиторий. Выполните работу по её README.</li></ol>
...
<div class="rules"><article><h3>Онлайн-работы</h3><p>После сдачи — мини-тест на практике: 5 минут, 5 вопросов. Балл за лабораторную: <strong>X × max(0,5; T)</strong>, где X — балл за решение, а T — доля баллов за тест от 0 до 1.</p><p>Мини-тест не переписывается. При пропуске T = 0, поэтому сохраняется половина баллов за решение.</p></article><article><h3>Очные защиты</h3><p>Покажите результат и объясните постановку задачи, выбор данных, методов и метрик, эксперименты и выводы. Формат и критерии указаны в условии конкретной работы.</p><p>LLM можно использовать как инструмент. Свои решения и полученные результаты нужно уметь объяснить самостоятельно.</p></article></div>
...
<section id="team"><div class="sectionhead"><h2>Команда курса</h2></div><div class="team"><div><h3>Лектор</h3><p>Елизавета Власова</p></div><div><h3>Практики</h3><p>Кирилл Захаров<br>Камила Насибуллина<br>Михаил Подсытник<br>Игорь Толстокулаков</p></div></div>@@chat_link@@</section>
